...
public class WeatherProvider extends ContentProvider {
    ...
    static{
        ...
        //weather  INNER JOIN locationON weather.location_id = location._id
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            // "weather"
            case WEATHER: {
                retCursor = this.mOpenHelper.getReadableDatabase().query(WeatherContract.WeatherEntry.TABLE_NAME,
                        projection,
                        selection,
                        selectionArgs,
                        null,
            ...
            // "location"
            case LOCATION: {
                retCursor = this.mOpenHelper.getReadableDatabase().query(WeatherContract.LocationEntry.TABLE_NAME,
                        projection,
                        selection,
                        selectionArgs,
                        null,
